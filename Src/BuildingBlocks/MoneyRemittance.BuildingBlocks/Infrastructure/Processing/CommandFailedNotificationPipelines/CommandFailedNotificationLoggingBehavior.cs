...
internal class CommandFailedNotificationLoggingBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
    where TRequest : ICommandFailedNotification, IRequest<TResponse>
{
    private readonly ILogger _logger;

    public CommandFailedNotificationLoggingBehavior(ILogger logger)
    {
        _logger = logger;
    }
